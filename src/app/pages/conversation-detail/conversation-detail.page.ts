...
import { PopoverController, Platform, ActionSheetController, NavParams, NavController, IonContent } from '@ionic/angular';
...
import { 
  ...
  TYPE_GROUP } from '../../services/utils/constants';
import { 
  compareValues, 
  isInArray, 
  isPopupUrl, 
...
export class ConversationDetailPage implements OnInit {
  ...
  initialize() {
    ...
    this.openInfoConversation = true; // indica se è aperto il box info conversazione
    this.online = false;
